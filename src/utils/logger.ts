...
const logger = {
    info: (msg: any) => 
        console.log(`${pc.gray(new Date().toLocaleTimeString())} ${pc.blue('INFO')} ${msg}`),
    
    warn: (msg: any) => 
        console.warn(`${pc.gray(new Date().toLocaleTimeString())} ${pc.yellow('WARN')} ${msg}`),
    
    error: (msg: any) => 
        console.error(`${pc.gray(new Date().toLocaleTimeString())} ${pc.red('ERROR')} ${msg}`),
